...
WHERE result::text LIKE '%assets.app.pubpub.org.s3.us-east-1.amazonaws.com%';
...
WHERE value::text LIKE '%assets.app.pubpub.org.s3.us-east-1.amazonaws.com%';
...
WHERE result::text LIKE '%s3.us-east-1.amazonaws.com/assets.app.pubpub.org%';
...
WHERE value::text LIKE '%s3.us-east-1.amazonaws.com/assets.app.pubpub.org%';
...
WHERE result::text LIKE '%assets.app.pubpub.org%';
...
WHERE value::text LIKE '%assets.app.pubpub.org%';
