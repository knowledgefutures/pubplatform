...
DELETE FROM "action_instances" WHERE "action" = 'buildJournalSite';
DELETE FROM "action_config_defaults" WHERE "action" = 'buildJournalSite';

-- AlterEnum
BEGIN;
CREATE TYPE "Action_new" AS ENUM ('log', 'email', 'http', 'move', 'googleDriveImport', 'datacite', 'buildSite', 'createPub');
